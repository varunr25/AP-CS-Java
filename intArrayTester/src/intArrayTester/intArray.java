...
public class intArray 
{
	...
	// Returns the sum of all the values in list L
	public int summation()
	{
		int sum = 0; 
		for (int x: this.L)	//for each value in L
		{
			sum += x;	//x = L[i]
		}
		return sum;
	...
	// Returns the average of all the values in list L
	public double average()
	{
		double average = 0.0;
		average = (double) summation() / L.length;
		return average;
	}
